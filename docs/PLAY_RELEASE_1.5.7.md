...
- Укажите в Play Console публичную политику: `https://api.gory-staff.ru/privacy`. Добавьте контакт издателя: его нельзя выдумывать, поэтому он остаётся за владельцем приложения.
