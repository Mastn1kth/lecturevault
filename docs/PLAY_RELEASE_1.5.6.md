...
- Укажите публичный URL политики конфиденциальности и контакт издателя. `PRIVACY.md` можно использовать как исходный текст, но Play Console требует доступную извне страницу.
